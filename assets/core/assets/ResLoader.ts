import { Asset, AssetManager, SpriteFrame, __private, assetManager, error, js, resources, warn } from "cc";
...
export class ResLoader {
     ...
     * @param onComplete    加载完成回调
     * @example
    app.res.load("spine_path", sp.SkeletonData, (err: Error | null, sd: sp.SkeletonData) => {
